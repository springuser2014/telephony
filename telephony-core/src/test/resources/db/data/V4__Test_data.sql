...
SELECT pg_catalog.setval('users_seq', 5, false);
...
SELECT pg_catalog.setval('stores_seq', 3, false);
...
SELECT pg_catalog.setval('user_stores_seq', 7, false);
...
SELECT pg_catalog.setval('roles_seq', 4, false);
...
SELECT pg_catalog.setval('user_roles_seq', 5, false);
-- CONTACTS
...
SELECT pg_catalog.setval('contacts_seq', 4, false);
...
SELECT pg_catalog.setval('sales_seq', 3, false);
