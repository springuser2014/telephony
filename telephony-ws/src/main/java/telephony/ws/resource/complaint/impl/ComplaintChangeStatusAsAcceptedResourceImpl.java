...
import telephony.ws.resource.complaint.ComplaintChangeStatusAsAcceptedResource;

import javax.ws.rs.Consumes;
import javax.ws.rs.Produces;
import javax.ws.rs.core.MediaType;

public class ComplaintChangeStatusAsAcceptedResourceImpl
extends TelephonyServerResource
implements ComplaintChangeStatusAsAcceptedResource {
    ...
    public ComplaintChangeStatusResponse markAsAccepted(ComplaintChangeStatusRequest request) {

        logger.info("ComplaintChangeStatusAsAcceptedResourceImpl.markAsAccepted starts");
