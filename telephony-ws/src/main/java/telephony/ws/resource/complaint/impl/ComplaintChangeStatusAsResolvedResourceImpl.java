...
import telephony.ws.resource.complaint.ComplaintChangeStatusAsResolvedResource;

import javax.ws.rs.Consumes;
import javax.ws.rs.Produces;
import javax.ws.rs.core.MediaType;

public class ComplaintChangeStatusAsResolvedResourceImpl
extends TelephonyServerResource
implements ComplaintChangeStatusAsResolvedResource {
    ...
    public ComplaintChangeStatusResponse markAsResolved(ComplaintChangeStatusRequest request) {

        logger.info("ComplaintChangeStatusAsResolvedResourceImpl.markAsResolved starts");
