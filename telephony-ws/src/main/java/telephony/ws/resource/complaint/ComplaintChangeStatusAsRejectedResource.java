...
public interface ComplaintChangeStatusAsRejectedResource {

    String URL = "/complaint/markAsRejected";

    @Post("json")
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ComplaintChangeStatusResponse markAsRejected(ComplaintChangeStatusRequest request);
