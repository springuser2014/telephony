...
<head>
    ...
    <script data-main="/telephony-web/resources/js/sales.js" src='<c:url value="/resources/js/libs/require-2.1.10.js"/>'>
    </script>
...
<script id="sale-search-form-template" type="x-tmpl-mustache">
                        ...
                        <div class="row">
                            <section class="col col-2">
                                <label class="input">
                                    ...
                                    <b class="tooltip tooltip-top-left">Nazwa sprzedaży</b>
                                </label>
                            </section>
...
<script id="sale-list-template" type="x-tmpl-mustache">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>{{sum}}</td>
            <td>
                <a class="btn btn-info btn-xs" href="<c:url value="/saleDetails/"/>{{id}}">Szczegóły</a>
                <a class="btn btn-success btn-xs" href="<c:url value="/editSale/"/>{{id}}">Edytuj</a>
                <a class="btn btn-danger btn-xs delete-sale tooltip" title='asdsadsad' sale-id="{{id}}" href="#">Usuń</a>
            </td>
        </tr>
        {{/sales}}
        </tbody>
...
<script id="sale-add-template" type="x-tmpl-mustache">
