						...
						<form id="checkout-form" class="smart-form"
								...
								<div class="row">
									...
									<section class="col col-6">
										<label class="input"> <i
											...
											name="phone" placeholder="Phone" data-mask="(999) 999-9999">
										</label>
									</section>
								</div>
							</fieldset>
							...
							<fieldset>
								<div class="row">
									...
									<section class="col col-3">
										<label class="input"> <input type="text" name="code"
								...
								<section>
									<label for="address2" class="input"> <input type="text"
							...
							<fieldset>
								...
								<div class="row">
									...
									<section class="col col-3">
										<label class="input state-error"> <input type="text"
											name="year" placeholder="Year" data-mask="2099"
											class="invalid">
										</label><em for="year" class="invalid">Digits only please</em>
									</section>
								</div>
							</fieldset>
